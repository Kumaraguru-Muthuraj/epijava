 ...
 */
public class LongestSelfContainedString {
    ...
    public static Comparator<String> cmp1 = new Comparator<String>() {
        @Override
        public int compare(String o1, String o2) {
            if (o1.length() < o2.length()) {
                return 1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(maxSubstringLength(s5));

        TreeSet<String> set = new TreeSet<>(cmp1);
        set.add("cat");
        set.add("hi");
        set.add("apple");
